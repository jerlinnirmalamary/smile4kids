...
<body>
    ...
    <div class=" container-fluid rounded">
        ...
        <form class="row g-3 needs-validation m-0 rounded form1" novalidate>
            <div class="word">Panjabi/TEENS CLASSES (11 TO 19 YEARS OLD) <br> <span>Student Details</span></div>
            <div class="col-md-6 first">
                <label for="validationCustom01" class="form-label">First name</label>
                <input type="text" class="form-control inpt" id="validationCustom01" placeholder="Enter First Name"
                    required>
            ...
            <div class="col-md-6 first">
                ...
                <input type="text" class="form-control inpt" id="validationCustom02" placeholder="Enter SurName"
                    required>
                <div class="invalid-feedback if">
            ...
            <div class="col-12 sub1">
                <button class="btn btn1" type="submit">Next</button>
            </div>

            <!-- SECOND -->

            <div class="word1">Panjabi/TEENS CLASSES (11 TO 19 YEARS OLD)<br> <span>Parent Details</span></div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="num" data-validation="number" data-validation-allowing="negative,number" input
                    name="color" data-validation="number" datavalidation-ignore="$" required="required"
                    class="form-control" id="phone_no" placeholder="Enter Phone Number">
                <div class="invalid-feedback if">
            ...
            <div class="col-12 sub2">
                <button class="btn pre_btn1" type="submit">Previous</button>
                <button class="btn btn2" type="submit">Next</button>
            </div>
            ...
            <div class="col-12 three">
                ...
                <div class="form-check">
                    ...
                    <p class="cp">I hereby consent to protect all the course materials and intellectual properties
                        obtained or
                        acquired
                ...
                <div class="form-check">
                    ...
                    <p class="cp">I shall not in case reproduce and /or distribute, allow reproduction and /or
                        distribution of any
                        such course material by any third party including but not limited to any of my family members
                        for commercial or non-commercial purpose. Course materials are being provided to my child who
                        had subscribed the course with Smile 4 Kids ltd and shall at all times be used solely by my
                        child only.</p>
                ...
                <div class="form-check">
                    ...
                    <p class="cp">I understand that selling, commercial copying, hiring or lending of course materials
                        are strictly
                        prohibited. I consent to indemnify Smile 4 Kids ltd for any losses or damages resulting out of
                        my failure to protect the course materials as mentioned above with my best endeavours.</p>
                ...
                <div class="form-check">
                    ...
                    <p class="cp">Smile 4 Kids will presume that the parents/other party has read and consented to all
                        the
                        terms and
                ...
                <div class="form-check">
                    ...
                    <p class="cp">I undertake that my child is under parental/guardian supervision, at all times, during
                        the
                        length of
                        the class. I agree not to hold Smile 4 Kids responsible, for being unable to supervise my child
                        individually.</p>
            ...
            <div class="col-12 sub3">
                <button class="btn pre_btn2" type="submit">Previous</button>
                <button class="btn btn3" type="submit">Next</button>
            </div>
            ...
            <div class="col-12 four">
                ...
                <div class="form-check">
                    <div class="word2">Data Protection & Terms and Conditions</div>
                    <p class="cp">I undertake that my child is under parental/guardian supervision, at all times, during
                        the length of the class. I agree not to hold Smile 4 Kids responsible, for being unable to
                ...
                <div class="form-check">
                    ...
                    <p class="cp">By enrolling my child onto a SMILE 4 KIDS course, I agree that I have read and will be
                ...
                <div class="form-check">
                    ...
                    <p class="cp">I consent to occasional classes being recorded for staff training purposes only. I
                        accept that I will have the right to decline or permit use of any footage of my child, when
                ...
                <div class="col-12 sub4">
                    <button class="btn pre_btn3" type="submit">Previous</button>
                    <button class="btn btn4" type="submit">Next</button>
                </div>
            </div>
            ...
            <div class="col-12 four">
                ...
                <div class="form-check">
                    <div class="word2">Data Protection & Terms and Conditions</div>
                    <p class="cp">I agree to reading all policies on SMILE 4 kids website including Health/safety,
                ...
                <div class="form-check">
                    ...
                    <p class="cp">I accept that no refund or partial refund will be given if a student leaves, part
                        term.</p>
                ...
                <div class="form-check">
                    ...
                    <p class="cp">I accept that any missed classes cannot be replaced/accommodated, on alternative
                        dates.</p>
                ...
                <div class="col-12 sub5">
                    <button class="btn pre_btn4" type="submit">Previous</button>
                    <button class="btn btn5" type="submit">Apply</button>
                </div>
            </div>
    </div>
